            ...
            <div className="card">
                <div className="card-image">
                    <figure className="image is-4by3">
                        ...
                        <span className="img-date-stamp">
                                <time
                                    dateTime="2016-1-1">{new Date(this.props.article.published_at).toDateString()}</time>
                            </span>
                    </figure>
                </div>
                <div className="card-content">
                    ...
                    <div className="content">
                        <a href={'/posts/' + this.props.article.id}
                           className="is-link title is-5">{this.props.article.title}</a>
